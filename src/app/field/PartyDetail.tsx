...
/**
 * Customer ledger + offline payment/invoice entry. Driven entirely by props and
 * the IndexedDB cache — NO route navigation — so switching to/from it works
 * offline regardless of the service worker (the Field page renders it inline).
 */
  ...
  return (
    <div className="space-y-4">
      <div>
        <button
          onClick={onBack}
          className="text-[12.5px] font-semibold text-muted hover:text-accent-deep"
        >
          ‹ All customers
        </button>
      ...
      {/* Pending (unsynced) entries for this customer */}
      {pending.length > 0 && (
