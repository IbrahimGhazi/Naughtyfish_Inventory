...
export const commonCopy: CopyFragment = [
  ...
  { key: "shell.nav.parties", default: "Parties", group: "Sidebar", label: "‘Parties’ nav item" },
  ...
  { key: "shell.topbar.title.parties", default: "Parties", group: "Topbar", label: "Parties page title" },
