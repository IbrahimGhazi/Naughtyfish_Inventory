...
export const purchasesCopy: CopyFragment = [
  ...
  { key: "purchases.new.colPackets", default: "Packets", group: "New Purchase", label: "Line column: packets (optional)" },
  { key: "purchases.new.lineInvalid", default: "This line is missing an item, weight or rate.", group: "New Purchase", label: "Incomplete-line warning" },
  ...
  { key: "purchases.new.natureRaw", default: "Raw", group: "New Purchase", label: "Item optgroup — raw" },
  { key: "purchases.new.natureProcessed", default: "Processed", group: "New Purchase", label: "Item optgroup — processed" },
  { key: "purchases.new.suppliedAs", default: "Supplier processing", group: "New Purchase", label: "Per-line supplier processes label" },
  { key: "purchases.new.suppliedAsHint", default: "how the supplier prepared it (optional)", group: "New Purchase", label: "Supplier processes hint" },
  ...
  { key: "purchases.detail.colPackets", default: "Packets", group: "Purchase Detail", label: "Line column: packets" },
